        ...
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <ul class="collapse list-unstyled" id="masterdataSubmenu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/tax_fuel_sales/list_tax_fuel_sales.jsp" class="list-group-item list-group-item-action ${currentPage == 'asset_condition' ? 'active' : ''}">
                            Pajak Bahan Bakar
                        </a>
                    </li>
                    <li>
