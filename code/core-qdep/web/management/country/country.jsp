...
<%!
...

	{
		...
		ctrlist.addHeader("Time To Gmt","5%");

		ctrlist.addHeader("Time To Locale","5%");
...
<%if(iCommand==Command.EDIT || iCommand==Command.ADD || iCommand==Command.ASK || (iCommand==Command.SAVE && iErrCode!=FRMMessage.NONE)){%>
                  ...
                  <td width="87%"> 
                    ...
                    <table width="100%" border="0">
					  ...
					  <% if(privAdd){%> 
                        ...
                        <td><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image100','','<%=approot%>/images/ctr_line/add_f2.jpg',1)"><img name="Image100" border="0" src="<%=approot%>/images/ctr_line/add.jpg" width="24" height="24" alt="Add New Country"></a></td>
                        ...
                        <td><a href="javascript:backMenu()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image300','','<%=approot%>/images/ctr_line/back_f2.jpg',1)"><img name="Image300" border="0" src="<%=approot%>/images/ctr_line/back.jpg" width="24" height="24" alt="Back To Master Data Management Menu"></a></td>

                                    <td nowrap><a href="javascript:backMenu()" class="command">Back 

                                      To Master Data Man. Menu</a></td>
                    ...
                    <table width="100%" border="0" cellspacing="5" cellpadding="1">
                      ...
                      <tr align="left" valign="top"> 
                        ...
                        <td height="8" valign="middle" colspan="3"> 
                          ...
                          <%if((iCommand ==Command.ADD)||(iCommand==Command.SAVE)&&(frmCountry.errorSize()>0)||(iCommand==Command.EDIT)||(iCommand==Command.ASK) || (iCommand==Command.SAVE && iErrCode!=FRMMessage.NONE)){%>
                              ...
                              <td height="21" colspan="2" width="83%"> 
                                ...
                                <%= frmCountry.getErrorMsg(FrmCountry.FRM_FIELD_TIME_TO_GMT) %> 
									...
									ctrLine.setBackCaption("Back to Country List");

									ctrLine.setCommandStyle("buttonlink");

									ctrLine.setSaveCaption("Save Country");

									ctrLine.setDeleteCaption("Delete Country");
